...
public class MinMaxAveTest {
    ...
    @Order(8)
    @Test
    public void testMinMaxAveIndex1EqualsIndex2() {
    ...
    @Order(9)
    @Test
    public void testMinMaxAveArrayLengthEqualsZero() {
    ...
    @Order(3)
    @Test
    public void testMinMaxAveArrayTwoValues() {
    ...
    @Order(4)
    @Test
    public void testMinMaxAveArrayTwoValuesNegative() {
